...
void print_student_list(list<studentas> mokinys, int pazymiu_sk, string filename) {
    ...
    for (auto& studentas : mokinys) {

        output << setprecision(5) << studentas.Vard + "           " + studentas.Pav + "           " << setprecision(3) << studentas.GP << endl;
...
void print_student_vector(vector<studentas> mokinys, int pazymiu_sk, string filename) {
    ...
    {
        studentas studentas = mokinys[i];

        output << studentas.Vard + "           " + studentas.Pav + "           " << setprecision(3) << studentas.GP << endl;
        /*output << std::setw(20) << std::left << mokinys[i].Vard
            << std::setw(20) << std::left << mokinys[i].Pav
            << std::setw(18) << std::left << mokinys[i].GP
            << "---" << std::endl;*/
...
void read_from_file_list(list<studentas>& Eil, int pazymiu_sk, string filename)
{
